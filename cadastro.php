...
<html lang="en">
    ...
    <body>
        ...
        <!--FORM-->
        <?php
            /*verificando se possui algum cadastro para ser alterado, caso 
            haja os campos serão prenchidos com as infomações do cliente*/
        ...
        <div class = "text-center">
            <h1 class="text-muted ">Cadastro de clientes</h1>
        </div>
    ...
    <?php
        /*Chamada dos métodos de criação e alteração*/
